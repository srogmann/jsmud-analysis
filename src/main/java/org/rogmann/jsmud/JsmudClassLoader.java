...
/**
 * Class-loader which may patch bytecode of classes to support static initizalizers or constructors.
 */
public class JsmudClassLoader extends ClassLoader {
	...
	/** <code>true</code> if static-initializers ("<&lt;linit&gt;") may be patched */
	...
	public Class<?> loadClass(String name) throws ClassNotFoundException {
		...
		if (patchFilter.test(name) && !isJreXmlClass) {
	...
	public Class<?> findClass(String name) throws ClassNotFoundException {
		...
		if (clazz == null) {
			...
			if (patchFilter.test(name) && (patchClinit || patchInit)) {
				...
				try (final InputStream isBytecode = parentClassLoader.getResourceAsStream(nameClass)) {
					if (isBytecode == null) {
				...
				try {
					Files.write(new File("/tmp/" + nameClass.replace('/', '.')).toPath(), bytecodePatched, StandardOpenOption.CREATE);
				} catch (IOException e) {
