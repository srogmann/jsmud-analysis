...
public class JsmudClassLoader extends ClassLoader {
	...
	public static final String METHOD_JSMUD_CLINIT = "__JSMUD_clinit";
	/** name of the default-constructor-flag */
	public static final String FIELD_CONSTR_FLAG = "__JSMUD_constr_flag";
	...
	public static final int FLAG_PATCHED_CLINIT = 4;
	 ...
	 * @param flag flag
	 */
	public void setClassFlag(final String className, final int flag) {
